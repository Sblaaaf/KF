...
const teamMembers = {
    1: {
        ...
        specialties: ['Kiné Générale', 'Kiné Sportive', 'Orthopédie', 'Ostéopathie D.O.'],
        techniques: ['Thérapie manuelle', 'Dry Needling', 'Analyse de la course', 'Clinique du coureur'],
        photo: '/assets/blob/GILLES_mini.webp',
    ...
    2: {
        ...
        specialties: ['Kiné Générale', 'Kiné Périnatale', 'Orthopédie', 'Rééducation Abdomino-pelvienne'],
        techniques: ['Thérapie manuelle', 'Myofasciale', 'Crochetage', 'ATM'],
        photo: '/assets/blob/MARIA_mini.webp',
    ...
    3: {
        ...
        specialties: ['Kiné Générale', 'Kiné Sportive', 'Orthopédie', 'Pré/post-opératoire', 'Céphalées', 'Rhumatologie', 'Reconditionnement physique'],
        techniques: ['Thérapie manuelle', 'Ondes de choc', 'Neurodynamique', 'Méthode McKenzie', 'Prévention des blessures du coureur', 'Crochetage'],
        photo: '/assets/blob/OLIVIER_mini.webp',
    ...
    4: {
        ...
        convention: 'Entièrement conventionné',
        languages: ['Français', 'Anglais'],
        specialties: ['Kiné Viscérale', 'Kiné Périnatale', 'Pré/post-opératoire', 'Rééducation Abdomino-pelvienne', 'Thérapie maxillo-faciale'],
        techniques: ['Myofasciale', 'Pilates', 'Crochetage', 'Renforcement musculaire', 'ATM'],
        photo: '/assets/blob/FANNY_mini.webp',
    ...
    5: {
        ...
        specialties: ['Kiné Générale', 'Kiné Sportive', 'Orthopédie', 'Ostéopathie D.O.'],
        techniques: ['Thérapie manuelle', 'Dry Needling', 'Analyse de la course', 'Clinique du coureur'],
        photo: '/assets/blob/SIMON_mini.webp',
    ...
    6: {
        ...
        photo: '/assets/blob/MATHILDE_mini.webp',
    ...
    7: {
        ...
        inami: '55675723527',
        convention: 'Entièrement conventionné',
        languages: ['Français', 'Anglais', 'Bases de Portugais'],
        specialties: ['Kiné Générale', 'Kiné Sportive', 'Orthopédie'],
        techniques: ['Thérapie manuelle', 'Myofasciale', 'Neurodynamique', 'Renforcement musculaire ciblé', 'Mc Kenzie', 'Crochetage'],
        photo: '/assets/blob/THOMAS_mini.webp',
        description: 'Thomas vous propose une prise en charge active et personnalisée visant à soulager vos douleurs et restaurer votre fonction. L\'accompagnement est centré sur un retour durable et sécurisé à vos activités du quotidien ou sportives.',
        contact: {
    ...
    /* 8: {
        ...
        photo: '/assets/blob/MARIE-INES_mini.webp',
    ...
    /* 9: {
        ...
        techniques: [],
        photo: '/assets/blob/ANNE-SOPHIE_mini.webp',
