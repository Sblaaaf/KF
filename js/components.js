...
function initComponents() {
    ...
    if (teamCards.length > 0) {
        ...
        const specialtyFilters = {
            ...
            'orthopedie': [3, 2, 7, 1, 5], // Olivier, Maria, Thomas, Gilles, Simon
    ...
    const renderSpecialties = () => {
        ...
        let content = `
            ...
            <i class="fa-solid fa-xmark modal__close"></i>
            <div class="modal__options" id="specialty-options" style="padding-bottom: 5.5rem;">`;
        ...
        content += `</div>
            <div style="position: absolute; bottom: 0; left: 0; right: 0; width: 100%; background-color: white; padding: 1rem; display: flex; justify-content: center; border-top: 1px solid var(--light);">
                <a href="https://rosa.be/fr/org/kineflagey/" target="_blank" class="button button--rosa-2" style="display: flex; width:auto; align-items: center; gap: 0.5rem; justify-content: center;">
                    <span>ou directement via Rosa.be</span>
                    <svg class="rosa-icon" style="width: 1.2em; height: 1.2em;"><use href="/assets/svg/sprite.svg#rosa"></use></svg>
                </a>
            </div>`;
