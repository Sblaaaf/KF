...
/*=============== HASH NAVIGATION - Activate services/techniques via megamenu links ===============*/
const initHashNavigation = () => {
    const handleHashNavigation = () => {
        ...
        if (hash.startsWith('service-')) {
            ...
            const serviceTab = servicesSection.querySelector(`.service-tab__card[data-service="${serviceId}"]`);
            
            // Dispatcher un vrai événement click
            if (serviceTab) {
                ...
                serviceTab.dispatchEvent(clickEvent);
            }
        }
        // Gestion des techniques
            ...
            const techniqueId = hash.replace('technique-', '');
            const techniqueTab = techniquesSection.querySelector(`.technique-tab__card[data-technique="${techniqueId}"]`);
            ...
            if (techniqueTab) {
                ...
                techniqueTab.dispatchEvent(clickEvent);
            }
        }
    ...
    // Écouter les changements de hash (quand on clique sur un lien)
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    Promise.all([
        ...
        initHashNavigation(); // Activation des services/techniques via les liens
